...
async def book_restaurant(*, city="Amsterdam", date=None, time="18:00",
    ...
    steps = [
        ...
        "4. From the resulting restaurant list, select a popular restaurant that seems suitable for {purpose} and click reserve a table.",
        ...
        "9. Proceed to confirm the booking and wait for the booking confirmation to appear.",
        "10. Capture the confirmation details or booking reference."
    ]
    ...
    if test_mode or os.environ.get('TEST_MODE', 'false').lower() == 'true':
        steps = [
            ...
            "6. STOP HERE - TEST MODE ACTIVE. Do not proceed with the booking process."
        ]
